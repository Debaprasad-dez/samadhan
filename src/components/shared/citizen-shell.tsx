...
export function CitizenShell({
  ...
  // Home and profile ship the design's own full-bleed layout (top bar, hero,
  // bottom nav), so the shell steps aside on those routes.
  if (pathname === "/" || pathname === "/profile") return <>{children}</>;
